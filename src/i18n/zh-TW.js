...
export default {
  ...
  settings: {
    ...
    agentTab: {
      title: '代理 Agent',
      desc: '把辨識出來的語音，交給所選「CLI + 模型來源」在工作目錄執行任務。開啟「Agent 模式」後，按右 Alt 講的話會交給 agent 執行（而非貼到游標）。',
      cliSection: 'CLI 工具（選擇用哪個跑 agent；Ollama 僅需安裝）',
      claudeInstalled: 'Claude Code 已安裝',
      codexInstalled: 'Codex 已安裝',
      ollamaInstalled: 'Ollama 已安裝',
      install: '安裝',
      sourceSection: '模型來源（{cli} 可用；點選使用 + 登入/切換/登出）',
      login: '登入',
      logout: '登出',
      switchAccount: '切換帳號',
      modelSection: '模型選擇',
