...
export default {
  ...
  settings: {
    ...
    agentTab: {
      title: '代理 Agent',
      desc: '把识别出来的语音，交给所选「CLI + 模型来源」在工作目录执行任务。开启「Agent 模式」后，按右 Alt 说的话会交给 agent 执行（而非贴到光标）。',
      cliSection: 'CLI 工具（选择用哪个跑 agent；Ollama 仅需安装）',
      claudeInstalled: 'Claude Code 已安装',
      codexInstalled: 'Codex 已安装',
      ollamaInstalled: 'Ollama 已安装',
      install: '安装',
      sourceSection: '模型来源（{cli} 可用；点选使用 + 登入/切换/登出）',
      login: '登入',
      logout: '登出',
      switchAccount: '切换账号',
      modelSection: '模型选择',
