...
export default {
  ...
  settings: {
    ...
    agentTab: {
      title: 'Agent',
      desc: 'Hand your dictated speech to the selected CLI + model source to run tasks in the working directory. With "Agent mode" on, what you say with right Alt is executed by the agent (not pasted at the cursor).',
      cliSection: 'CLI tools (pick which one runs the agent; Ollama only needs installing)',
      claudeInstalled: 'Claude Code installed',
      codexInstalled: 'Codex installed',
      ollamaInstalled: 'Ollama installed',
      install: 'Install',
      sourceSection: 'Model source ({cli} available; click to use + sign in/switch/out)',
      login: 'Sign in',
      logout: 'Sign out',
